export default class Validate {
  ...
  static minlength(value, param) {
    return this.optional(value) || this.getByteLength(value) >= param
  }
  /**
   * 验证最大长度
   */
  static maxlength(value, param) {
    console.log('this.getByteLength(value)', this.getByteLength(value))
    return this.optional(value) || this.getByteLength(value) <= param
  }
  /**
   * 验证一个长度范围[min, max]
  ...
  static rangelength(value, param) {
    return this.optional(value) || (this.getByteLength(value) >= param[0] && this.getByteLength(value) <= param[1])
  }
  /**
   * 验证最小值
   */
   ...
   * 正则验证
   */
  static pattern(value, param) {
    return this.optional(value) || param.test(value)
  }
}
